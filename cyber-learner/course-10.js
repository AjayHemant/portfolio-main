...
document.addEventListener("DOMContentLoaded", () => {
  ...
  nextCourseBtn.addEventListener("click", () => {
    window.location.href = "course-11.html"
  })
  ...
  function markCourseComplete() {
    ...
    if (!progress.completedCourses.includes(10)) {
      progress.completedCourses.push(10)
      progress.currentCourse = 11
