// Course 7 - Subnetting & IP Math JavaScript
document.addEventListener("DOMContentLoaded", () => {
  ...
  nextCourseBtn.addEventListener("click", () => {
    window.location.href = "course-8.html"
  })
  ...
  function markCourseComplete() {
    ...
    if (!progress.completedCourses.includes(7)) {
      progress.completedCourses.push(7)
      progress.currentCourse = 8
