// Course 12 - Burp Suite JavaScript
document.addEventListener("DOMContentLoaded", () => {
  ...
  nextCourseBtn.addEventListener("click", () => {
    window.location.href = "course-13.html"
  })
  ...
  function markCourseComplete() {
    ...
    if (!progress.completedCourses.includes(12)) {
      progress.completedCourses.push(12)
      progress.currentCourse = 13
